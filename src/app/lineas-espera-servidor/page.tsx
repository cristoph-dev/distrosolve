...
import { AlertCircle, BarChart3, ChevronLeft, ChevronRight, HelpCircle, Info, Server } from "lucide-react";
            ...
            {!hasCalculated || !results ? (
              ...
              <div className="grid lg:grid-cols-[1fr_1.1fr]">
                <div className="grid grid-cols-2 border-b border-zinc-800 lg:border-b-0 lg:border-r">
                  <Metric label="Rho" value={`${(results.rho * 100).toFixed(2)}%`} sub="Utilización" tooltip="Probabilidad de que el servidor esté ocupado" />
                  <Metric label="Tasa servicio" value={format(results.serviceRate)} sub="μ" tooltip="Cantidad promedio de clientes que el servidor puede atender por unidad de tiempo" />
                  ...
                  <Metric label="Lq" value={format(results.Lq)} sub="Clientes cola" tooltip="Número promedio de clientes esperando en la cola" />
